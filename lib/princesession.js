...
import axios from 'axios'; // You will need to install axios to handle HTTP requests
...
async function processTxtAndSaveCredentials(txt) {
  ...
  if (isBase64) {
    ...
    const dropboxUrl = `https://www.dropbox.com/s/${dropboxCode}?dl=1`; // Direct link to download
